...
#subtitle: An aptitude–treatment interaction study
format: 
  clean-revealjs:  
...
::: incremental
-   “What is the [airspeed velocity]{.fg style="--col: #1f78b4"} of an
    unladen [swallow]{.fg style="--col: #1f78b4"}?”
    -   [32.4
...
-   What is your [quest]{.fg style="--col: #1f78b4"}? 😀
...
-   Paradigm [shift]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert} Two
...
-   [Prof. Harald
    ...
    (my regression modeling [teacher]{.fg style="--col: #1f78b4"}! 😀)
...
2.  To provide a [practical]{fg="#FFFFFF" bg="#1f78b4"} introduction to
    ...
    -   Free, open-source statistical software [→]{.alert}
...
::: incremental
-   [Simple]{.fg style="--col: #1f78b4"} statistical model [→]{.alert}
    [Mean]{.fg style="--col: #1f78b4"}
    -   [Hypothetical]{.fg style="--col: #1f78b4"} value [→]{.alert}
        [Doesn't]{.fg style="--col: #1f78b4"} have to be observed in the
        data
    -   Model ([prediction]{.fg style="--col: #1f78b4"}) [→]{.alert}
...
::: {style="margin-left: 44.2%; margin-top: -2%;"}
[2]{.fg style="--col: #31a354"} = [5.1]{.fg style="--col: #1f78b4"} + =
[-3.1]{.fg style="--col: #da291c"} [→]{.alert} Deviation ([residual]{.fg
style="--col: #da291c"})
:::
::::
:::::
...
-   The [General Linear Model]{colour="#FFFFFF" bg-colour="#da291c"}
    ...
    -   [Model]{.fg style="--col: #1f78b4"} [→]{.alert} ['Things']{.fg
...
::: incremental
-   [Model]{.fg style="--col: #1f78b4"} to be fit [→]{.alert}
...
::: incremental
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert}
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert}
    ...
    -   [Intercept]{.fg style="--col: #1f78b4"} [→]{.alert}
        [Baseline]{fg="#FFFFFF" bg="#1f78b4"}
    -   [[Slope]{.fg style="--col: #da291c"} [→]{.alert} [Rate]{.fg
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert}
    ...
    -   [Slope]{.fg style="--col: #da291c"} [→]{.alert} [Rate of
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert}
    ...
    -   [[Intercept]{.fg style="--col: #1f78b4"} [→]{.alert}
        [Baseline]{.fg style="--col: #1f78b4"}]{.fg style="opacity: 0.2"}
    -   [Slope]{.fg style="--col: #da291c"} [→]{.alert}
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert} Regression
    ...
    -   [[Intercept]{.fg style="--col: #1f78b4"} [→]{.alert}
        [Baseline]{.fg style="--col: #1f78b4"} [⟹]{.fg
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert} Regression
    ...
    -   [Intercept]{.fg style="--col: #1f78b4"} [→]{.alert}
        [Baseline]{fg="#FFFFFF" bg="#1f78b4"} [⟹]{.alert} [b~0~]{.fg
        style="--col: #1f78b4"} = [beta zero]{fg="#FFFFFF" bg="#1f78b4"}
        (X = [0]{.fg style="--col: #1f78b4"})
    -   [[Slope]{.fg style="--col: #da291c"} [→]{.alert} [Rate of
        change]{.fg style="--col: #da291c"} [⟹]{.alert} [b~1~]{.fg
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert} Regression
    ...
    -   [[Intercept]{.fg style="--col: #1f78b4"} [→]{.alert} [Predictor
        value]{.fg style="--col: #1f78b4"} = [0]{.fg
        style="--col: #1f78b4"} (zero)]{.fg style="opacity: 0.2"}
    -   [Slope]{.fg style="--col: #da291c"} [→]{.alert} [The effect of
...
-   [Regression line]{.fg style="--col: #1f78b4"} [→]{.alert} Regression
    ...
    -   [[Intercept]{.fg style="--col: #1f78b4"} [→]{.alert} [Predictor
        value]{.fg style="--col: #1f78b4"} = [0]{.fg
        style="--col: #1f78b4"} (zero)]{.fg style="opacity: 0.2"}
    -   [Slope]{.fg style="--col: #da291c"} [→]{.alert} [Effect
...
-   [Normality]{.fg style="--col: #1f78b4"}
    -   Errors ([not variables!]{.fg style="--col: #1f78b4"})
        [→]{.alert} [Normally]{.fg style="--col: #1f78b4"} distributed
...
-   [Equal]{.fg style="--col: #1f78b4"} variance (Homoskedasticity)
    -   Errors ([residuals]{.fg style="--col: #1f78b4"}) [→]{.alert}
...
-   [Class 1]{fg="#FFFFFF" bg="#E69F00"} (lectures & materials all
    available online) [→]{.alert} [No]{fg="#FFFFFF" bg="#E69F00"}
...
-   [Class 2]{fg="#FFFFFF" bg="#009E73"} (some materials online)
    [→]{.alert} [Negative]{fg="#FFFFFF" bg="#009E73"}
    correlation`r gen_fn(1, "fn1")`
...
-   [Class 3]{fg="#FFFFFF" bg="#0072B2"} (nothing online) [→]{.alert}
...
-   [Independence]{colour="#FFFFFF" bg-colour="#31a354"} assumption:
    ...
    [→]{.alert} [Correlated]{colour="#FFFFFF"
...
-   Results in [artificially]{.fg style="--col: #1f78b4"} low *p*-values
    [↓]{colour="#FFFFFF" bg-colour="#1f78b4"} ([biased]{colour="#FFFFFF"
    bg-colour="#da291c"})
    -   [Type 1 errors]{colour="#FFFFFF" bg-colour="#da291c"} go
        [↑]{colour="#FFFFFF" bg-colour="#da291c"}
:::
...
-   [Aggregation]{.fg style="--col: #1f78b4"}
    -   [Means]{.fg style="--col: #1f78b4"} [→]{.alert} Entered into the
        analysis
    -   Subject and item [variability]{fg="#FFFFFF" bg="#1f78b4"}
        [→]{.alert} [Collapsed]{fg="#FFFFFF" bg="#1f78b4"}
        -   Model [→]{.alert} Understimates variability (i.e.,
            [Loses]{fg="#FFFFFF" bg="#da291c"} information)
        -   Model [→]{.alert} Has [less]{fg="#FFFFFF" bg="#da291c"}
...
::: {.fragment .semi-fade-out fragment-index="1"}
-   [Aggregated]{.fg style="--col: #da291c"} data [→]{.alert} [One]{.fg
    style="--col: #da291c"} data point for [each]{.fg
    style="--col: #da291c"} subject
:::

::: {.fragment .fade-in-then-semi-out fragment-index="1"}
-   [Unaggregated]{.fg style="--col: #1f78b4"} data [→]{.alert}
...
::: {.fragment .fade-in-then-semi-out fragment-index="1"}
-   [*p*-values]{.fg style="--col: #1f78b4"} [→]{.alert}
    [Artificially]{.fg style="--col: #1f78b4"} low [↓]{colour="#FFFFFF"
    bg-colour="#1f78b4"}
    -   [Increase]{.fg style="--col: #da291c"} of [Type I
        error]{fg="#FFFFFF" bg="#da291c"} rates [↑]{colour="#FFFFFF"
        bg-colour="#da291c"}
...
-   [Solution]{fg="#FFFFFF" bg="#1f78b4"}:
    -   [Innovative]{.fg style="--col: #1f78b4"} method [→]{.alert}
...
::: {style="opacity: 1;"}
-   [Intercept]{.fg style="--col: #1f78b4"} [→]{.alert} Baseline
-   [Slope]{.fg style="--col: #da291c"} [→]{.alert} [Fixed]{.fg
...
-   [New]{fg="#FFFFFF" bg="#31a354"} [→]{.alert} [Random]{fg="#FFFFFF"
...
::: {.fragment .fade-in-then-semi-out fragment-index="1"}
-   [More flexible]{.fg style="--col: #1f78b4"} [→]{.alert} Can deal
...
-   Put simply, they allow [simultaneous]{.fg style="--col: #1f78b4"}
    ...
    -   Hence, the name [→]{.alert} [Mixed-effects]{fg="#FFFFFF"
...
::: {.fragment .fade-in-then-semi-out fragment-index="1"}
-   Represent [average]{fg="#FFFFFF" bg="#1f78b4"} effects [→]{.alert}
...
-   Basically the [same]{fg="#FFFFFF" bg="#1f78b4"} condition effects
    [→]{.alert} [Standard]{.fg style="--col: #1f78b4"} regression
:::
...
-   Should have [at least 5]{fg="#FFFFFF" bg="#31a354"} levels
    -   [More]{fg="#FFFFFF" bg="#31a354"} levels [→]{.alert}
...
-   What would we [call]{.fg style="--col: #1f78b4"} these regression
    lines?`r gen_fn(1, "fn1")` [→]{.alert} [random slopes]{fg="#FFFFFF"
    bg="#31a354"}
...
### [Random effects]{fg="#FFFFFF" bg="#31a354"}: [Everybody]{fg="#FFFFFF" bg="#1f78b4"} gets an estimate! 😀
...
::: {.fragment .fade-in-then-semi-out fragment-index="1"}
-   [Individual]{.fg style="--col: #1f78b4"} estimates [→]{.alert}
...
-   (Conceptually & statistically) [Easy]{colour="#FFFFFF"
    bg-colour="#1f78b4"} [→]{.alert} Predictor = [Numbers]{.fg
    style="--col: #1f78b4"}
...
-   [Intercept]{.fg style="--col: #1f78b4"} [→]{.alert} Represents the
...
-   [Intercept]{.fg style="--col: #1f78b4"} [→]{.alert} Represents
...
-   [Rescaling]{.fg style="--col: #1f78b4"} predictor to [ease]{.fg
    ...
    -   [Uncentered]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert}
...
-   [Predictor -- Mean score]{.fg style="--col: #1f78b4"}
    -   [Centered]{fg="#FFFFFF" bg="#da291c"} [→]{.alert}
...
-   [Evidence]{fg="#FFFFFF" bg="#31a354"} [→]{.alert} [Skipping
...
-   [No evidence]{fg="#FFFFFF" bg="#da291c"} [→]{.alert} [Skipping
...
-   [Intercept]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert} Estimated [mean
...
-   [Intercept]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert} When
...
-   [Slope]{fg="#FFFFFF" bg="#da291c"} [→]{.alert}
...
-   [Slope]{fg="#FFFFFF" bg="#da291c"} [→]{.alert} Grade is expected to
...
-   [Intercept]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert} Amount of
...
-   [Intercept]{fg="#FFFFFF" bg="#1f78b4"} [→]{.alert} Fixed intercept
...
-   [Slope]{fg="#FFFFFF" bg="#da291c"} [→]{.alert} [[Amount of]{.fg
...
-   [Slope]{fg="#FFFFFF" bg="#da291c"} [→]{.alert} Fixed slope (i.e.,
...
-   [Correlation]{.fg style="--col: #1f78b4"} random intercepts and
    random slopes [→]{.alert} [Negative]{.fg style="--col: #E69F00"}
...
-   Classes with [larger intercepts]{.fg style="--col: #1f78b4"}
    [→]{.alert} Tend to have [more negative slopes]{.fg
    style="--col: #da291c"}
...
-   Skipping class [→]{.alert} [[Affects]{.fg style="--col: #1f78b4"}
...
-   [Unexplained]{fg="#FFFFFF" bg="#da291c"} variability [→]{.alert}
...
-   [Linearity]{.fg style="--col: #1f78b4"}
    ...
    -   [Changes]{.fg style="--col: #1f78b4"} in predictor [→]{.alert}
...
::::: {.fragment .semi-fade-out fragment-index="1"}
-   Standard [linear]{.fg style="--col: #1f78b4"} model [→]{.alert}
...
-   [Logistic]{.fg style="--col: #1f78b4"} regression model:
    ...
    -   [Transforming]{.fg style="--col: #1f78b4"} outcome (Y)
        [→]{.alert} [Continuous]{.fg style="--col: #1f78b4"} scale ([log
...
-   [Outcome]{.fg style="--col: #1f78b4"}: Speech errors [→]{.alert}
...
-   On [average]{.fg style="--col: #1f78b4"}, [drunk]{.fg
    style="--col: #1f78b4"} people [→]{.alert} Make [more]{.fg
...
::: nonincremental
-   Predicting [log odds]{fg="#FFFFFF" bg="#1f78b4"} ([‘logits’]{.fg
...
-   Predicting [log odds]{fg="#FFFFFF" bg="#1f78b4"} ([‘logits’]{.fg
    ...
    -   [Positive]{.fg style="--col: #1f78b4"} ([+]{fg="#FFFFFF"
        ...
        -   *Probability* [\>]{.fg style="--col: #1f78b4"} 0.5
            [→]{.alert} Above 50% [more]{fg="#FFFFFF" bg="#1f78b4"}
            likely to occur
...
-   Predicting [log odds]{fg="#FFFFFF" bg="#1f78b4"} ([‘logits’]{.fg
    ...
    -   [Negative]{.fg style="--col: #da291c"} ([-]{fg="#FFFFFF"
        ...
        -   *Probability* [\<]{.fg style="--col: #da291c"} 0.5
            [→]{.alert} Above 50% [less]{fg="#FFFFFF" bg="#da291c"}
            likely to occur
...
::: {.fragment .semi-fade-out fragment-index="1"}
-   [Independence]{.fg style="--col: #1f78b4"} assumption [→]{.alert}
    [Fundamental]{colour="#FFFFFF" bg-colour="#31a354"}
:::
